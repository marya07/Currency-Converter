...
public enum Translator {
    ENGLISH("ENGLISH", "Welcome!", "Help",  "Convert",
            ...
            "This is used to convert currencies. Select which currencies you would like to convert " +
                    ...
                    "Would you like to convert more?", "Fee Charged: "),
    ...
    Translator(String language, String greetingLabelTextText, String helpButtonTextText, String convertButtonTextText,
               String termsBoxText, String helpMessage,   String summaryTitle, String transactionProcessed, String currencyDeposited,
               String currencyWithdrawn, String thanksMessage, String repeatText, String feeCharged) {
